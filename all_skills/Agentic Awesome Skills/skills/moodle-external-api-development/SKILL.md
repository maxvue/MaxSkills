...
description: "This skill guides you through creating custom external web service APIs for Moodle LMS, following Moodle's external API framework and coding standards. Use when developing, optimizing, debugging, or configuring moodle external api development in production workflows."
risk: critical
source: community
