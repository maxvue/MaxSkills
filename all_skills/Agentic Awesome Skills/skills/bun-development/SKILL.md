...
description: "Fast, modern JavaScript/TypeScript development with the Bun runtime, inspired by [oven-sh/bun](https://github.com/oven-sh/bun). Use when developing, optimizing, debugging, or configuring bun development in production workflows."
risk: critical
source: community
