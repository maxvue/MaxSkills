...
description: "Guide for implementing and maintaining context as a managed artifact alongside code, enabling consistent AI interactions and team alignment through structured project documentation. Use when developing, optimizing, debugging, or configuring context driven development in production workflows."
risk: critical
source: community
