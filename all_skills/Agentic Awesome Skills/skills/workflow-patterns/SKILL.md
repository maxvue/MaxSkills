...
description: "Use this skill when implementing tasks according to Conductor's TDD workflow, handling phase checkpoints, managing git commits for tasks, or understanding the verification protocol. Use when developing, optimizing, debugging, or configuring workflow patterns in production workflows."
risk: safe
source: community
