...
description: "Expert in Odoo QWeb templating for PDF reports, email templates, and website pages. Covers t-if, t-foreach, t-field, and report actions. Use when developing, optimizing, debugging, or configuring odoo qweb templates in production workflows."
risk: safe
source: "self"
---
