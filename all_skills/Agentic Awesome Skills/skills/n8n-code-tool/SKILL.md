---
name: n8n-code-tool
description: "Write and debug JavaScript or Python for the AI-callable n8n Custom Code Tool, including schemas, sandbox limits, and return formats. Use when developing, optimizing, debugging, or configuring n8n code tool in production workflows."
risk: critical
