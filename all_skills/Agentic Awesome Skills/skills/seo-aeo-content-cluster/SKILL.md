...
description: "Builds a topical authority map with a pillar page, prioritised cluster articles, content types, internal link map, and content gap analysis. Activate when the user wants to build a content cluster, topic map, or content strategy. Use when developing, optimizing, debugging, or configuring seo aeo content cluster in production workflows."
risk: safe
source: community
