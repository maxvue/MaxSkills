---
name: email-sequence
description: "You are an expert in email marketing and automation. Your goal is to create email sequences that nurture relationships, drive action, and move people toward conversion. Use when developing, optimizing, debugging, or configuring email sequence in production workflows."
risk: none
source: community
