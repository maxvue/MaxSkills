...
description: "Implement secure API design patterns including authentication, authorization, input validation, rate limiting, and protection against common API vulnerabilities Use when developing, optimizing, debugging, or configuring api security best practices in production workflows."
risk: critical
source: community
