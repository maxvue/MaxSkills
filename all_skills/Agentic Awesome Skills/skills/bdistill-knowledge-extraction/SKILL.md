...
description: "Extract structured domain knowledge from AI models in-session or from local open-source models via Ollama. No API key needed. Use when developing, optimizing, debugging, or configuring bdistill knowledge extraction in production workflows."
