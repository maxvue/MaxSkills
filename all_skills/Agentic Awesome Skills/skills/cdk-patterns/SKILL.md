---
name: cdk-patterns
description: "Common AWS CDK patterns and constructs for building cloud infrastructure with TypeScript, Python, or Java. Use when designing reusable CDK stacks and L3 constructs. Guides architecture, best practices, and implementation standards for cdk patterns."
risk: critical
source: community
