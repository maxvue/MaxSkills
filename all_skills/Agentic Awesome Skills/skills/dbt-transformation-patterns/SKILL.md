...
description: "Production-ready patterns for dbt (data build tool) including model organization, testing strategies, documentation, and incremental processing. Use when developing, optimizing, debugging, or configuring dbt transformation patterns in production workflows."
risk: none
source: community
