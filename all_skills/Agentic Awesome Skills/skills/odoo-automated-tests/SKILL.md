...
description: "Write and run Odoo automated tests using TransactionCase, HttpCase, and browser tour tests. Covers test data setup, mocking, and CI integration. Use when developing, optimizing, debugging, or configuring odoo automated tests in production workflows."
risk: safe
source: "self"
---
