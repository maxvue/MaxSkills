...
description: "Automate SendGrid email delivery workflows including marketing campaigns (Single Sends), contact and list management, sender identity setup, and email analytics through Composio's SendGrid toolkit. Use when developing, optimizing, debugging, or configuring sendgrid automation in production workflows."
risk: critical
source: community
