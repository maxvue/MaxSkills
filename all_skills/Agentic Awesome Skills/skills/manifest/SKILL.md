---
name: manifest
description: "Install and configure the Manifest observability plugin for your agents. Use when setting up telemetry, configuring API keys, or troubleshooting the plugin. Guides architecture, best practices, and implementation standards for manifest."
risk: critical
source: community
