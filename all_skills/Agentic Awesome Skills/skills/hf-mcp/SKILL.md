---
name: hf-mcp
description: "Use Hugging Face Hub via MCP server tools. Search models, datasets, Spaces, papers. Get repo details, fetch documentation, run compute jobs, and use Gradio Spaces as AI tools. Available when connected to the HF MCP server. Use when developing, optimizing, debugging, or configuring hf mcp in production workflows."
risk: critical
