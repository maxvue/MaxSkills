...
description: "Azure Cosmos DB JavaScript/TypeScript SDK (@azure/cosmos) for data plane operations. Use for CRUD operations on documents, queries, bulk operations, and container management. Use when developing, optimizing, debugging, or configuring azure cosmos ts in production workflows."
risk: critical
source: community
