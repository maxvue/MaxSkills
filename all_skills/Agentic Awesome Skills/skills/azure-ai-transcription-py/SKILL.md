...
description: "Azure AI Transcription SDK for Python. Use for real-time and batch speech-to-text transcription with timestamps and diarization. Use when developing, optimizing, debugging, or configuring azure ai transcription py in production workflows."
risk: critical
source: community
