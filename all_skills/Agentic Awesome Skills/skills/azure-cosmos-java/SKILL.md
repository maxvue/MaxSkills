...
description: "Azure Cosmos DB SDK for Java. NoSQL database operations with global distribution, multi-model support, and reactive patterns. Use when developing, optimizing, debugging, or configuring azure cosmos java in production workflows."
risk: critical
source: community
