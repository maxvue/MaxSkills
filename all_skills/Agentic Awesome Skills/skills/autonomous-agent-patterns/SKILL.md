...
description: "Design patterns for building autonomous coding agents, inspired by [Cline](https://github.com/cline/cline) and [OpenAI Codex](https://github.com/openai/codex). Use when developing, optimizing, debugging, or configuring autonomous agent patterns in production workflows."
risk: critical
source: community
