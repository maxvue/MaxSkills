...
description: "Design and implement multi-tenant SaaS architectures with row-level security, tenant-scoped queries, shared-schema isolation, and safe cross-tenant admin patterns in PostgreSQL and TypeScript. Use when developing, optimizing, debugging, or configuring saas multi tenant in production workflows."
risk: safe
source: community
