...
description: "Azure AI Document Translation SDK for batch translation of documents with format preservation. Use for translating Word, PDF, Excel, PowerPoint, and other document formats at scale. Use when developing, optimizing, debugging, or configuring azure ai translation document py in production workflows."
risk: critical
source: community
