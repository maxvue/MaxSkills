...
description: "Builds production-ready REST API endpoints with validation, error handling, authentication, and documentation. Follows best practices for security and scalability. Use when developing, optimizing, debugging, or configuring api endpoint builder in production workflows."
