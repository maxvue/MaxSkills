...
description: "Specialized AI agent skill for nextjs app router providing best practices and automated workflows."
description_pt_br: "Regras arquiteturais para Next.js 15 com App Router, RSC e Server Actions."
repository: "Awesome"
url_skill: "https://github.com/vercel/next.js"
stars: 4500
languages: []
frameworks: []
libs: []
...
### Português (pt-BR)
Aumenta a performance do agente de IA em nextjs app router com padrões de execução estruturados e prevenção de erros.

**Descrição Detalhada:**
Regras arquiteturais para Next.js 15 com App Router, RSC e Server Actions.

### English
Enhances AI agent performance in nextjs app router with structured execution patterns and error-prevention guidelines.

**Detailed Description:**
Specialized AI agent skill for nextjs app router providing best practices and automated workflows.
...
- **Repositório Oficial:** [Awesome](https://github.com/vercel/next.js)
...
1. Execução determinística e de alta fidelidade para rotinas de `nextjs-app-router`.
