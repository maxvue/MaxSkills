---
name: lucide-icons
description: "Specialized AI agent skill for lucide icons providing best practices and automated workflows."
description_pt_br: "Inserção padronizada de iconografia vetorial limpa e acessível."
repository: "Awesome"
url_skill: "https://github.com/lucide-icons/lucide"
stars: 4500
languages: []
frameworks: []
libs: []
...
### Português (pt-BR)
Aumenta a performance do agente de IA em lucide icons com padrões de execução estruturados e prevenção de erros.

**Descrição Detalhada:**
Inserção padronizada de iconografia vetorial limpa e acessível.

### English
Enhances AI agent performance in lucide icons with structured execution patterns and error-prevention guidelines.

**Detailed Description:**
Specialized AI agent skill for lucide icons providing best practices and automated workflows.
...
- **Repositório Oficial:** [Awesome](https://github.com/lucide-icons/lucide)
...
1. Execução determinística e de alta fidelidade para rotinas de `lucide-icons`.
