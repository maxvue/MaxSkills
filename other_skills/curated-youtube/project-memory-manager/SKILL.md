...
description: "Specialized AI agent skill for project memory manager providing best practices and automated workflows."
description_pt_br: "Gerencia memória de longo prazo e persistência de contexto em repositórios via arquivos estruturados."
repository: "Awesome"
url_skill: "https://github.com/disler/indydevtools"
stars: 4500
languages: []
frameworks: []
libs: []
...
### Português (pt-BR)
Aumenta a performance do agente de IA em project memory manager com padrões de execução estruturados e prevenção de erros.

**Descrição Detalhada:**
Gerencia memória de longo prazo e persistência de contexto em repositórios via arquivos estruturados.

### English
Enhances AI agent performance in project memory manager with structured execution patterns and error-prevention guidelines.

**Detailed Description:**
Specialized AI agent skill for project memory manager providing best practices and automated workflows.
...
- **Repositório Oficial:** [Awesome](https://github.com/disler/indydevtools)
...
1. Execução determinística e de alta fidelidade para rotinas de `project-memory-manager`.
