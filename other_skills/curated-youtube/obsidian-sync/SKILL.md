---
name: obsidian-sync
description: "Specialized AI agent skill for obsidian sync providing best practices and automated workflows."
description_pt_br: "Integração e sincronização bidirecional entre vaults do Obsidian e o agente de IA."
repository: "Awesome"
url_skill: "https://github.com/WesRoth"
stars: 4500
languages: []
frameworks: []
libs: []
...
### Português (pt-BR)
Aumenta a performance do agente de IA em obsidian sync com padrões de execução estruturados e prevenção de erros.

**Descrição Detalhada:**
Integração e sincronização bidirecional entre vaults do Obsidian e o agente de IA.

### English
Enhances AI agent performance in obsidian sync with structured execution patterns and error-prevention guidelines.

**Detailed Description:**
Specialized AI agent skill for obsidian sync providing best practices and automated workflows.
...
- **Repositório Oficial:** [Awesome](https://github.com/WesRoth)
...
1. Execução determinística e de alta fidelidade para rotinas de `obsidian-sync`.
