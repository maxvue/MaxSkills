---
name: deepseek-reasoner-harness
description: "Specialized AI agent skill for deepseek reasoner harness providing best practices and automated workflows."
description_pt_br: "Estrutura especializada para guiar o raciocínio em cadeia (CoT) de modelos DeepSeek R1/V3."
repository: "Awesome"
url_skill: "https://github.com/deepseek-ai/DeepSeek-V3"
stars: 4500
languages: []
frameworks: []
libs: []
...
# Skill: deepseek-reasoner-harness

## 📖 Visão Geral (Overview)

### Português (pt-BR)
Aumenta a performance do agente de IA em deepseek reasoner harness com padrões de execução estruturados e prevenção de erros.

**Descrição Detalhada:**
Estrutura especializada para guiar o raciocínio em cadeia (CoT) de modelos DeepSeek R1/V3.

### English
Enhances AI agent performance in deepseek reasoner harness with structured execution patterns and error-prevention guidelines.

**Detailed Description:**
Specialized AI agent skill for deepseek reasoner harness providing best practices and automated workflows.
...
- **Repositório Oficial:** [Awesome](https://github.com/deepseek-ai/DeepSeek-V3)
...
1. Execução determinística e de alta fidelidade para rotinas de `deepseek-reasoner-harness`.
