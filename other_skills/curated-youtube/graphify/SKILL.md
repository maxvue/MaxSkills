---
name: graphify
description: "Specialized AI agent skill for graphify providing best practices and automated workflows."
description_pt_br: "Transforma o repositório em um grafo de conhecimento consultável para navegação sem perda de contexto."
repository: "Awesome"
url_skill: "https://github.com/disler/the-library"
stars: 4500
languages: []
frameworks: []
libs: []
...
### Português (pt-BR)
Aumenta a performance do agente de IA em graphify com padrões de execução estruturados e prevenção de erros.

**Descrição Detalhada:**
Transforma o repositório em um grafo de conhecimento consultável para navegação sem perda de contexto.

### English
Enhances AI agent performance in graphify with structured execution patterns and error-prevention guidelines.

**Detailed Description:**
Specialized AI agent skill for graphify providing best practices and automated workflows.
...
- **Repositório Oficial:** [Awesome](https://github.com/disler/the-library)
...
1. Execução determinística e de alta fidelidade para rotinas de `graphify`.
