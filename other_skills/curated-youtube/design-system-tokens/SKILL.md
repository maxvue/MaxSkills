...
description: "Specialized AI agent skill for design system tokens providing best practices and automated workflows."
description_pt_br: "Sincronização de tokens de design entre ferramentas visuais e bases de código."
repository: "Awesome"
url_skill: "https://github.com/tokens-studio/figma-plugin"
stars: 4500
languages: []
frameworks: []
libs: []
...
### Português (pt-BR)
Aumenta a performance do agente de IA em design system tokens com padrões de execução estruturados e prevenção de erros.

**Descrição Detalhada:**
Sincronização de tokens de design entre ferramentas visuais e bases de código.

### English
Enhances AI agent performance in design system tokens with structured execution patterns and error-prevention guidelines.

**Detailed Description:**
Specialized AI agent skill for design system tokens providing best practices and automated workflows.
...
- **Repositório Oficial:** [Awesome](https://github.com/tokens-studio/figma-plugin)
...
1. Execução determinística e de alta fidelidade para rotinas de `design-system-tokens`.
