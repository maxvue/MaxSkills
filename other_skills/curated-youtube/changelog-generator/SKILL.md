...
description: "Specialized AI agent skill for changelog generator providing best practices and automated workflows."
description_pt_br: "Extração e categorização automática de commits para geração de changelogs e notas de release semânticas."
repository: "Awesome"
url_skill: "https://github.com/coleam00/skills"
stars: 4500
languages: []
frameworks: []
libs: []
...
### Português (pt-BR)
Aumenta a performance do agente de IA em changelog generator com padrões de execução estruturados e prevenção de erros.

**Descrição Detalhada:**
Extração e categorização automática de commits para geração de changelogs e notas de release semânticas.

### English
Enhances AI agent performance in changelog generator with structured execution patterns and error-prevention guidelines.

**Detailed Description:**
Specialized AI agent skill for changelog generator providing best practices and automated workflows.
...
- **Repositório Oficial:** [Awesome](https://github.com/coleam00/skills)
...
1. Execução determinística e de alta fidelidade para rotinas de `changelog-generator`.
