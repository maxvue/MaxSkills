...
- Utilize o `useLocalStorage` do MaxUse (`@maxvue/max-use`, que reexporta o VueUse) ou um utilitário de storage próprio do projeto para persistir o tamanho dos painéis.
...
import { useLocalStorage } from '@maxvue/max-use';
...
// Persistência reativa usando useLocalStorage (serialização/parse automáticos)
