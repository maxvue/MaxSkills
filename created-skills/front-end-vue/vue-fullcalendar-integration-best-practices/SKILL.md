...
* Você pode definir `events` como uma função callback ou fornecer um array reativo de uma Pinia store ou ref diretamente nas opções computadas ou como uma prop separada.
