...
- **422 Unprocessable Entity (Entidade Não Processável)**: Formate os erros de validação (comumente retornados por validadores como o VineJS) e rejeite a Promise com os erros estruturados para que os componentes de formulário possam exibir as mensagens de validação diretamente nos campos correspondentes.
