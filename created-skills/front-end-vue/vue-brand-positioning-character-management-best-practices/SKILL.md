...
description: Use when creating, modifying, styling, or debugging components, pages, or Pinia stores related to brand positioning, character profiles, agent persona configurations, upload of character face reference images, and topic/theme lists in Vue 3. Triggers on files modifying TabBrandPositioning, TabCharacters, TabThemes, characters store, and related UI components.
---
...
* Implemente formulários reativos e com salvamento automático para as diretrizes da marca (ex: tom de voz, público-alvo, configurações de logotipo) para evitar perda de dados.
...
* Certifique-se de vincular o estado a uma store dedicada do Pinia (ex: `useBrandPositioningStore`).
