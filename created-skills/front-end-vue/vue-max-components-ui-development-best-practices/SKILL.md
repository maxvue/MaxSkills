...
* **Formatação do SFC**:
  ...
  - Dentro do bloco `<template>`, formate os componentes Vue mantendo todos os atributos/parâmetros em uma única linha (estilo inline). Não quebre os atributos em várias linhas.
