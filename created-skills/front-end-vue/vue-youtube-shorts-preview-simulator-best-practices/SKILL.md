      ...
      <div class="native-ui">
        ...
        <div class="actions-sidebar">
          <div class="action-item">
            <MaxIconButton :icon="isLiked ? 'mdi:thumb-up' : 'mdi:thumb-up-outline'" @action="toggleLike" />
...
- Obtenha as informações do canal ativo dinamicamente a partir da skill `vue-tenant-client-context-best-practices` para preencher as variáveis `channelHandle` e `channelAvatarUrl`.
- Vincule os estados de reprodução (como controle de volume, silenciamento ou progresso do vídeo) à store local do Pinia para gerenciar visualizações no calendário editorial ou páginas de mídias.
