...
- **NÃO** realize requisições à API da Meta diretamente dentro dos componentes visuais. Mantenha requisições dentro das stores do Pinia (`Stores/`) ou serviços dedicados e exponha-as através de composables limpos.
