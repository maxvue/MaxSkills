...
### 1. Singleton do TransmitClient (`resources/Js/transmit.ts`)
...
import { useTransmitClient } from '@/Js/transmit'
...
import { useTransmitChannel } from '@/Js/composables/useTransmitChannel'
