...
const pdfSource = ref<string>('/document/datasheet/123')
...
1.  Use um `ResizeObserver` ou o `useResizeObserver` da biblioteca `@vueuse/core` para monitorar as alterações de largura do container.
