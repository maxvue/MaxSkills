...
Este exemplo demonstra como escrever um teste unitário para um agente de IA no AdonisJS v6 utilizando o Japa e a classe `MockLanguageModelV2` do Vercel AI SDK.
