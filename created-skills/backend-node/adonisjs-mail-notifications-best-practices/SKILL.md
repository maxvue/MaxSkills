...
* **Variáveis de Ambiente (`start/env.ts`):** Sempre valide as variáveis relacionadas ao envio de e-mails (ex: `SMTP_HOST`, `SMTP_PORT`, `RESEND_API_KEY`) para evitar falhas em tempo de execução.
