...
- **Parâmetros do Modelo:** Padronize parâmetros que equilibrem qualidade e custo:
  ...
  - Defina claramente `maxSteps` (até 30) e `maxCalls` (up to 5) ao utilizar ferramentas agentícias (AI Tools).
