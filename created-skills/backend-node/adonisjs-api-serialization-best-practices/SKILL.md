...
export default class User extends BaseModel {
  ...
  // Serializado como instagramHandle em vez de instagramAccount
  @column({ serializeAs: 'instagramHandle' })
  declare instagramAccount: string
}
```
...
export default class MarketingAgency extends BaseModel {
  @column({ isPrimary: true })
  declare id: string
