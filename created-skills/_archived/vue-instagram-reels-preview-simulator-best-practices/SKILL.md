...
- Utilize os helpers de `@maxvue/max-use` (disponíveis via auto-import, sem necessidade de import manual) para rastrear fatores de escala vertical ou orientação da tela, se necessário.
