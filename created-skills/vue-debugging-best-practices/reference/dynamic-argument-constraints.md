...
// null - OK (the ONLY sanctioned non-string value; removes the binding)
const attr3 = null

// undefined - WARNING (any non-string other than null warns)
const attr4 = undefined  // Warning: not sanctioned; use null to remove a binding
