...
* **Veja também:** ao chamar URLs de origem parcial ou totalmente controlada pelo usuário (webhooks, callbacks, importação por URL), aplique as validações de `adonisjs-outbound-http-ssrf-defense-best-practices` antes de disparar a requisição.
